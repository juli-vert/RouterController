...
curl -X POST "http://127.0.0.1:8089/link?name=demo-r2-1&ip=192.168.102.12&mask=24&cost=80"
...
curl -X POST "http://127.0.0.1:8089/link?name=demo-r1-1&ip=192.168.104.11&mask=24&cost=50"
curl -X POST "http://127.0.0.1:8089/link?name=demo-r1-1&ip=192.168.201.11&mask=24&cost=60"
